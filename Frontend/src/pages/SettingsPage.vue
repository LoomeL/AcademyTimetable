...
<template>
  <div class="d-flex flex-column gap-1">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <i
        :class="{
          'fa-sun': settingsStore.settings.darkTheme,
          'fa-moon': !settingsStore.settings.darkTheme
        }"
        class="text-body-tertiary fa-regular fs-4 pe-1"
        @click="settingsStore.settings.darkTheme = !settingsStore.settings.darkTheme"
      ></i>
    </div>
      ...
      <div :key="element.id" class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <i
              class="fa-solid fa-pencil fs-5 text-body-tertiary"
              @click="profilesStore.editorSelectedProfile = JSON.parse(JSON.stringify(element))"
            ></i>
          </div>
          <hr class="my-2 mb-1" />
  ...
  <div v-else class="text-center my-3">Нет ни одного профиля</div>
